...
class Comment extends Model {
 ...
 public function create(int $photoId,int $userId,string $comment): void { $s=$this->db->prepare('INSERT INTO comments(photo_id,user_id,comment) VALUES(?,?,?)'); $s->execute([$photoId,$userId,$comment]); }
}
?>
